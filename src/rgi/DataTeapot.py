...
def dataTeapotX():
  ...
  k2 = 172
  k3 = 266
  x = [k2,k2,k2,k2,k2,k2,k2]
  t = [x1[k2][30],x1[k2][60],x1[k2][90],x1[k2][120],x1[k2][150],x1[k2][180],x1[k2][210]]
  f = [0.5,0.9,0.5,0.9,0.5,0.9,0.5]
  '''
  x = [k1,k1,k1,k1,k1,k1,k1,
       k2,k2,k2,k2,k2,k2,k2,
       k3,k3,k3,k3,k3,k3,k3]
  t = [x1[k1][30],x1[k1][60],x1[k1][90],x1[k1][120],x1[k1][150],x1[k1][180],x1[k1][210],
       x1[k2][30],x1[k2][60],x1[k2][90],x1[k2][120],x1[k2][150],x1[k2][180],x1[k2][210],
       x1[k3][30],x1[k3][60],x1[k3][90],x1[k3][120],x1[k3][150],x1[k3][180],x1[k3][210]]
  f = [0.5,0.9,0.5,0.9,0.5,0.9,0.5,
...
def imageTeapot():
  ...
  ais = ArrayInputStream("../../../data/seis/rgi/tp73.dat")
...
def rgtTeapot():
  nt,nx = 251,357
  image = zerofloat(nt,nx)
  ais = ArrayInputStream("../../../data/seis/rgi/rgt.dat")
  ais.readFloats(image)
  ais.close()
  return image
...
def x1Teapot():
  nt,nx = 251,357
  image = zerofloat(nt,nx)
  ais = ArrayInputStream("../../../data/seis/rgi/x1.dat")
  ais.readFloats(image)
  ais.close()
  return image
...
def plot2Teapot(f,x1,x2,s,s1,s2,g=None,label=None,png=None,et=None):
  ...
  if et:
    ...
    cmap = ColorMap(2.0,2.8,ColorMap.JET)
