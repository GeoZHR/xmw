...
pngDir = None
pngDir = "../../../png/ad/defense/"

seismicDir = "../../../data/seis/ad/dave/"
#fxfile = "bb"
#fxfile = "dd"
fxfile = "hh"
#fxfile = "ss"
...
def goDave():
  for k in range(25):
    ...
    sm = readImage(fn)
    sm = sub(1,sm)
    plot(sm,cmin=min(sm),cmax=max(sm),png=fxfile+"dave"+str(k))
...
def plot(f,cmap=ColorMap.GRAY,cmin=None,cmax=None,label=None,
