...
public class LocalOrientFilterW {
   ...
   */
  public LocalOrientFilterW(double sigma1, double sigma2) {
   ...
   */
  public LocalOrientFilterW(double sigma1, double sigma2, double sigma3) {
    ...
    float[][][] ep, float[][][] el)
  {
    ...
    for (int i2=0; i2<n2; ++i2) {
    for (int i1=0; i1<n1; ++i1) {
      float g2i = abs(g2[i3][i2][i1]);
      float g3i = abs(g3[i3][i2][i1]);
      float scale = g2i+g3i;
      scale *= scale;
      scale *= scale;
      g1[i3][i2][i1] *= scale;
