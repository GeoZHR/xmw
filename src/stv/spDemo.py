...
def main(args):
  ...
  #makePyramidSteerSumandCascadePlot2D("atwj1s.dat")
  SubtractPlanesthenHighlightChannels3D("flt.dat")
  return
...
def makePyramidSteerSumandCascadePlot2D(filename):
  ...
  for i in range(0,1,1):
    '''
    pyr = spyr.makePyramidX(y)
    spyr.steerScaleX(x,o,pyr)
    y = spyr.sumPyramidX(pyr)
    plot(y,0.0125,)
    '''
    pyr = spyr.makePyramid(y,o)
    attr = spyr.estimateAttributes(8.0,pyr)
