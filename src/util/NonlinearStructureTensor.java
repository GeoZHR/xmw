...
public class NonlinearStructureTensor {
   ...
   */
  public NonlinearStructureTensor(double sigma) {
   ...
   */
  public NonlinearStructureTensor(double sigma1, double sigma2) {
   ...
   */
  public NonlinearStructureTensor(double sigma1, double sigma2, double sigma3) {
  ...
  private void isotropicDiffusion(float[][] fx) {
