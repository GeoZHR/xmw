...
public class ChannelEnhanceFilter {
   ...
   */
  public ChannelEnhanceFilter(double sigma) {
   ...
   */
  public ChannelEnhanceFilter(double sigma1, double sigma2) {
   ...
   */
  public ChannelEnhanceFilter(double sigma1, double sigma2, double sigma3) {
  ...
  public EigenTensors2 applyForLinear(
    float sigma, EigenTensors2 et, float[][] sc, float[][] x,float[][] el)
  {
    // Gradient.
    int n2 = x.length;
    int n1 = x[0].length;
    ...
    lsf.apply(et,c,sc,g11,g11);
    lsf.apply(et,c,sc,g12,g12);
    lsf.apply(et,c,sc,g22,g22);
