...
public class LocalOrientFilterK {
   ...
   */
  public LocalOrientFilterK(double sigma1, double sigma2) {
   ...
   */
  public LocalOrientFilterK(double sigma1, double sigma2, double sigma3) {
    ...
    for (int i2=0; i2<n2; ++i2) {
      for (int i1=0; i1<n1; ++i1) {
        ...
        */
        ...
        if (el!=null) el[i2][i1] = (eui-evi)/den;
