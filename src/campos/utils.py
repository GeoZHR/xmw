...
def setupForSubset(name):
  ...
  if name=="campos":
    ...
    print "setupForSubset: campos full"
    seismicDir = _datdir+"campos/full/"
    n1,n2,n3 = 900,3765,2302
    d1,d2,d3 = 1.0,1.0,1.0 
    #d1,d2,d3 = 0.002,0.025,0.025 # (s,km,km)
    #f1,f2,f3 = 420,0,0
    ...
    #f1,f2,f3 = 0.000,5400,10744
    s1,s2,s3 = Sampling(n1,d1,f1),Sampling(n2,d2,f2),Sampling(n3,d3,f3)
  elif name=="nathanSub8Molet":
    print "setupForSubset: nathanSub8"
    seismicDir = _datdir+"nathan/sub8/molet/"
    ...
    n1,n2,n3 = 500,500,500  #fx = copy(n1,3675,550,0,1100,60,fx)
    d1,d2,d3 = 1.0,1.0,1.0 
    f1,f2,f3 = 0.0,0.0,0.0
    #d1,d2,d3 = 0.002,0.025,0.025 # (s,km,km)
    #f1,f2,f3 = 0.000,5400,10744
    s1,s2,s3 = Sampling(n1,d1,f1),Sampling(n2,d2,f2),Sampling(n3,d3,f3)
  elif name=="nathanSub2d":
