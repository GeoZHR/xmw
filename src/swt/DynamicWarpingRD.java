...
public class DynamicWarpingRD {
   ...
   */
  public DynamicWarpingRD(double smin, double smax, Sampling s1) {
   ...
   */
  public DynamicWarpingRD(double smin, double smax, Sampling s1, Sampling s2) {
