 ...
 * in the range [0,1].
 *
 * This java class is modified from Dave's LocalSmoothingFitler 
 * so that spatially variant smoothing filters are applied to 
 * construct structure tensors for orientation estimation.
 *
 * @author Dave Hale, Colorado School of Mines
 * @author Xinming Wu, Colorado School of Mines
 * @version 2015.06.06
 */
public class LocalOrientFilterX {

  /**
   * Constructs a filter with an isotropic Gaussian window.
   * @param sigma constant scale factor in 1st dimension.
   */
  public LocalOrientFilterX(double sigma) {
    this(sigma,sigma,sigma);
  }
  
  /**
   * Constructs a filter with a possibly anisotropic window.
   * @param sigma1 constant scale factor in 1st dimension.
   * @param sigma2 constant scale factor in 2nd dimension.
   */
  public LocalOrientFilterX(double sigma1, double sigma2) {
    this(sigma1,sigma2,sigma2);
  }

  /**
   * Constructs a filter with a possibly anisotropic window.
   * @param sitma1 constant scale factor in 1st dimension.
   * @param sigma2 constant scale factor in 2nd dimension.
   * @param sigma3 constant scale factor in 3rd dimension.
   */
  public LocalOrientFilterX(double sigma1, double sigma2, double sigma3) {
    ...
    float[][] el)
  {
    ...
    for (float[][] g:gs) {
      smooth1(_sigma1,_scales2,g);
      smooth2(_sigma2,_scales2,g);
    }
    ...
    float[][][] ep, float[][][] el)
  {
    ...
    */
    ...
    for (float[][][] g:gs) {
      smooth1(_sigma1,_scales3,g);
      smooth2(_sigma2,_scales3,g);
      smooth3(_sigma3,_scales3,g);
    }
  ...
  private float[][] _scales2 = null;
  private float[][][] _scales3 = null;
