 ...
 * @version 2017.12.08
 */
public class RelativeGeologicTime2 {
   ...
   */
  public float[][] applyForRgt( float[][] u1, float[][] u2, float[][] el) {
    int n2 = u1.length;
    int n1 = u1[0].length;
    ...
    A2 a2 = new A2(smoother2,_weight1,el,u1,u2);
  ...
  private static class A2 implements CgSolver.A {
    A2(Smoother2 s2, float w1, float[][] wp, float[][] u1, float[][] u2) {
      _s2 = s2;
      _w1 = w1;
      _wp = wp;
      _u1 = u1;
  ...
  private static void makeRhs(float[][] y) {
    zero(y);
  }
  private static void makeRhs(float w1, float[][] wp, float[][] y) {
    int n1 = y[0].length;
    int n2 = y.length;
    float w1s = w1*w1;
  ...
  private static void applyLhs(
    float w1, float[][] wp, float[][] u1, float[][] u2, float[][] x, float[][] y) 
  {
    int n1 = x[0].length;
    int n2 = x.length;
    float w1s = w1*w1;
