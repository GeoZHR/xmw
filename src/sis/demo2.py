...
def goSeg():
  ...
  gs = GeodesicSegmentation()
  fx1 = [250,100,300,250,380,380]
  fx2 = [250,400,400,900,620,800]
  bx1 = [200,500,300, 400,270,450]
  bx2 = [350,400,600,1030,800,760]
  u1 = zerofloat(n1,n2)
  u2 = zerofloat(n1,n2)
  el = zerofloat(n1,n2)
  lof = LocalOrientFilterP(2,2)
  lof.applyForNormalLinear(gx,u1,u2,el)
  sg = gs.apply(fx1,fx2,bx1,bx2,el)
  plot2(gx,s1,s2)
  plot2(el,s1,s2,cmin=0.1,cmax=0.9)
  plot2(sg,s1,s2,cmin=0.1,cmax=0.9)
  plot2(gx,s1,s2,sg,cmin=0,cmax=1.0,cmap=jetRamp(1.0))
