...
def goFaultTime():
  ...
  ft = readImage(ftfile)
  ff = FaultTime()
  et = ff.makeImageTensors(fl,ft)
  ts = ff.timeImage(et,fl)
  plotTensors(gx,s1,s2,et,dscale=2)
  plot2(s1,s2,gx,fl,gmin=0,gmax=1,title="fault likelihood")
  plot2(s1,s2,gx,ts,gmin=0,gmax=20,title="time")
...
def plotTensors(g,s1,s2,d=None,dscale=1,cmin=0,cmax=0,png=None):
