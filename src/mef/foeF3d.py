...
def goFaultSemblance():
  gx = readImage(gxfile)
  sem = readImage(semfile)
  sem=sub(1,sem)
  lof = LocalOrientFilterP(8.0,2.0,2.0)
  ets = lof.applyForTensors(gx)
  foe = FaultOrientEstimator(20,10,10)
  semt = foe.thin(0.1,sem)
  etf = foe.applyForTensors(15,2,2,semt,True)
  ets.setEigenvalues(0.001,1.0,1.0)
  etf.setEigenvalues(0.001,1.0,1.0)
  ...
  lsf.apply(etf,80,sn,sn) 
  lsf.apply(etf,80,sd,sd) 
  fl = div(sn,sd)
  fl = pow(fl,6)
  fl = sub(1,fl)
