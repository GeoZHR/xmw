...
minPhi,maxPhi = 0,360
minTheta,maxTheta = 35,85
sigmaPhi,sigmaTheta = 5,15
...
def goFakeData():
  ...
  gx,p2,p3 = FakeDataC.seismicAndSlopes3d2014A(
...
def goSemblance():
  ...
  sub(sem,min(sem),sem)
  div(sem,max(sem),sem)
  plot3(gx,sem,k3=56,cmin=0.4,cmax=0.9,cmap=jetRamp(1.0),
          clab="Fault attribute",png="semblance")
  plot3(gx,cmin=-3,cmax=3,cmap=ColorMap.GRAY,clab="Amplitude",png="seismic")
...
def goSkinE():
  ...
  #plot3(gx,skins=skins,png="skinsCrossE")
...
def goTv():
  ...
  plot3(gx,sm,k3=56,cmin=0.40,cmax=0.9,cmap=jetRamp(1.0),clab="Surfaceness",png="sm")
  plot3(gx,cm,k3=56,cmin=0.40,cmax=0.9,cmap=jetRamp(1.0),
