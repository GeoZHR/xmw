...
public class LocalOrientFilterS {
   ...
   */
  public LocalOrientFilterS(double sigma1, double sigma2) {
   ...
   */
  public LocalOrientFilterS(double sigma1, double sigma2, double sigma3) {
