...
public class LocalOrientFilterR {
   ...
   */
  public LocalOrientFilterR(double sigma1, double sigma2) {
   ...
   */
  public LocalOrientFilterR(double sigma1, double sigma2, double sigma3) {
    ...
    float[][] el)
  {
    ...
    HilbertTransform ht = new HilbertTransform(100,1);
    ht.applyInFrequency(x,g1,g2);
    ...
    float[][][] ep, float[][][] el)
  {
    ...
    HilbertTransform ht = new HilbertTransform(100,1);
    ht.applyInFrequency(x,g1,g2,g3);
