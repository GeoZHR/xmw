 ...
 * @version 2014.12.17
 */
public class FaultSurferPSS {

  public FaultSurferPSS(int n1, int n2, int n3, FaultCell[] fc) {
    _n1 = n1;
    _n2 = n2;
    _n3 = n3;
    _fc = fc;
  ...
  private float[][][][] faultImagesFromCells(FaultCell[] fc) {
    ...
    float[][][] sf = pss.findScalarField(_n1,_n2,_n3,fc);
    float[][][] fl = convertToFaultLikelihood(sf);
