...
def goHorizon():
  ...
  rs = array(r1,r2,r3)
  ts = array(t1,t2,t3)
  ws = he.findInUnfaultSpace(i1,rs)
  xs = he.findInCurrentSpace(i1,ws,ts,rs)
  gx = gain(gx)
  #he.setHorizon(xs,gx)
  qg = he.applyForTg(xs,gx,sk)
  #plot3(gx,qg=qg)
  plot3(gw)
  ...
  scs = mul(100,fls)
  gxs = sub(gx,scs)
  plot3(gxs,g=fls,qg=qg,cmin=0.01,cmax=1.0,
        cmap=jetFillExceptMin(1.0),cint=0.1,png="horizon5")
...
def goSlices():
  ...
  fw = readImage(fwfile)
  gw = readImage(gwfile)
  r1 = readImage(ft1file)
  r2 = readImage(ft2file)
  r3 = readImage(ft3file)
  gx = gain(gx)
  fw = gain(fw)
  gw = gain(gw)
  ...
  plot3f(gx,a=r1,amin=-10,amax=10,
        amap=jetFill(0.3),alab="Vertical shifts (samples)",
        aint=2.0,png="verticalShifts")
  plot3f(gx,a=r2,amin=-2,amax=2,
        amap=jetFill(0.3),alab="Inline shifts (samples)",
        aint=2.0,png="inlineShifts")
  plot3f(gx,a=r3,amin=-3,amax=3,
        amap=jetFill(0.3),alab="Crossline shifts (samples)",
        aint=2.0,png="crosslineShifts")
