...
def setupForSubset(name):
  ...
  if name=="s1":
    ...
    """ a smaller subset of s2 """
    print "setupForSubset: s2a"
    seismicDir = _datdir+"s2a/"
    n1,n2,n3 = 401,350,547
    d1,d2,d3 = 1.0,1.0,1.0
    ...
    """ a smaller subset of s2a """
    print "setupForSubset: s2x"
    seismicDir = _datdir+"s2x/"
