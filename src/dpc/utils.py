...
def setupForSubset(name):
  ...
  if name=="fake":
    ...
    f1,f2,f3 = 0,0,0 # = 0.000,0.000,0.000
    s1,s2,s3 = Sampling(n1,d1,f1),Sampling(n2,d2,f2),Sampling(n3,d3,f3)
  elif name=="hz25":
    print "setupForSubset: hz25"
    seismicDir = _datdir+"hz25/"
    #n1,n2,n3 = 150,2001,2001
    n1,n2,n3 = 512,956,488
    d1,d2,d3 = 1.0,1.0,1.0 
    #d1,d2,d3 = 0.002,0.008,0.008 # (s,km,km)
    f1,f2,f3 = 0.0,0.0,0.0 # = 0.000,0.000,0.000
    s1,s2,s3 = Sampling(n1,d1,f1),Sampling(n2,d2,f2),Sampling(n3,d3,f3)
  elif name=="geng":
    print "setupForSubset: geng"
    seismicDir = _datdir+"geng/"
    #n1,n2,n3 = 150,2001,2001
    n1,n2,n3 = 1400,500,455
    d1,d2,d3 = 1.0,1.0,1.0 
    #d1,d2,d3 = 0.002,0.008,0.008 # (s,km,km)
    f1,f2,f3 = 0.0,0.0,0.0 # = 0.000,0.000,0.000
    s1,s2,s3 = Sampling(n1,d1,f1),Sampling(n2,d2,f2),Sampling(n3,d3,f3)
  elif name=="gengSub":
    print "setupForSubset: gengSub"
    seismicDir = _datdir+"geng/sub/"#2055/"
    #n1,n2,n3 = 150,2001,2001
    n1,n2,n3 = 1000,500,455
    d1,d2,d3 = 1.0,1.0,1.0 
    #d1,d2,d3 = 0.002,0.008,0.008 # (s,km,km)
    f1,f2,f3 = 0.0,0.0,0.0 # = 0.000,0.000,0.000
    s1,s2,s3 = Sampling(n1,d1,f1),Sampling(n2,d2,f2),Sampling(n3,d3,f3)
