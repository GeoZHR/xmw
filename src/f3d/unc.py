...
def goUncSurfaces():
  ...
  unc1 = readImage2D(n2,n3,unc1file)
  unc2 = readImage2D(n2,n3,unc2file)
  ...
  sub(uc,min(uc),uc)
  div(uc,max(uc),uc)
  plot3(gx,png="seismicSub4")
  plot3(gx,uc,cmin=0.1,cmax=1,cmap=jetRamp(1.0),
          clab="Unconformity likelihood",png="uncSub4")
  plot3(gx,uc,cmin=0.1,cmax=1,cmap=jetRamp(1.0),uncs=[unc1,unc2],png="uncsSub4")
  '''
...
def goUncs():
  ...
  uh.thin(0.2,us,ut)
  uncs = uh.surfer(n2,n3,0.2,50000,ut,us)
  #uh.surfaceUpdate(2,2,sks,gx,uncs)
...
def plot3(f,g=None,cmin=None,cmax=None,cmap=None,clab=None,cint=None,
  ...
  ov.setTranslate(Vector3(-0.08,0.12,-0.13))
  #ov.setAzimuthAndElevation(-60.0,35.0)
  ov.setAzimuthAndElevation(-125.0,32.0)
