...
def goHorizon1():
  gx = readImage(gxfile)
  k11 = [173,159,170,178,280,276,239,207,179,282,231,256,221,239,259,271,284,226]
  k12 = [895,915,928,869, 34,810,855,878,938,917,786,763,711,627,102,415,495,764]
  k13 = [533,549,528,530,541,479,485,492,555,112,112,112,112,112, 92,463, 42, 65]
  ...
  writeImage(hz1file,surf) 
  plot3(gx)
  plot3(gx,hz=surf)

def goHorizon2():
  gx = readImage(gxfile)
  k13 = [559,559,559,525,525,525,552,549,549,549,490,
         490,440,246,246,239,206,160, 45]
  k12 = [109,668,850,910,928,942,938,903,885,845,798,
         667,227,236,562,620,714,385,302]
  k11 = [163,123, 60, 58, 54, 45, 39, 57, 61, 68,106,
         130,159,161,139,131,125,158,162]
...
def goScan():
  ...
  plot3(gx,fp,cmin=90,cmax=180,cmap=hueFill(1.0),
      clab="Fault strike (degrees)",cint=15,png="fp")
  #plot3(gx,convertDips(ft),cmin=35,cmax=50,cmap=jetFill(1.0),
  plot3(gx,ft,cmin=75,cmax=85,cmap=jetFill(1.0),
...
def goSkin():
  ...
  if not plotOnly:
    ...
    fs = FaultSkinner()
    fs.setGrowLikelihoods(lowerLikelihood,upperLikelihood)
    fs.setMaxDeltaStrike(10)  # sub1
    fs.setMaxPlanarDistance(0.2) #sub1
...
def goReSkin():
  ...
  '''
  plot3(gx,skins=skins,clab="skinsNew")
def goSmooth():
  print "goSmooth ..."
  gx = readImage(gxfile)
  if not plotOnly:
...
def plot3(f,g=None,cmin=None,cmax=None,cmap=None,clab=None,cint=None,
          ...
          links=False,curve=False,trace=False,hs=None,hz=None,
          uncs=None,uncx=None,png=None):
  n1,n2,n3 = s1.count,s2.count,s3.count
  ...
  if hz:
    tg=TriangleGroup(True,s3,s2,hz)
