...
def goScan():
  ...
  plot3(gx,fp,cmin=minPhi,cmax=maxPhi,cmap=jetRamp(1.0),
      clab="Fault strike (degrees)",cint=10,png="fp")
...
def goThin():
  ...
  plot3(gx,fpt,cmin=minPhi,cmax=maxPhi,cmap=jetFillExceptMin(1.0),
...
def goSlip():
  ...
  plot3(gx,skins=skins,smax=40.0,slices=[85,5,60],png="skinss1")
  plot3(gx,s1,cmin=0,cmax=40.0,cmap=jetFillExceptMin(1.0),
