...
public class FaultSkinnerT {
  ...
  public void findSkins(int n1, int n2, int n3, String seisDir,FaultCell[] cells) {
    skinsX(n1,n2,n3,seisDir,cells);
  }
  ...
  */
  ...
  private void skinsX(int n1, int n2, int n3, String seisDir, 
    FaultCell[] cells) {
    int sk = 0;
    int skinNo = 0;
