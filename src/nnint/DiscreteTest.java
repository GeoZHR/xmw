...
public class DiscreteTest {
  ...
  private static void plot3d(String png,
  ...
  private static void testInterpolation(int mode) {
    ...
    plot3d("sinsinV",s,s1,s2,p);
    plot3d("sinsinT",s,s1,s2,qf);
    //plot3d(s,s1,s2,q0);
    //plot3d(s,s1,s2,q1);
    //plot3d(s,s1,s2,q2);
    plot3d("sinsinI",s,s1,s2,q3);
    //plot3d(s,s1,s2,q4);
    //plot3d(s,s1,s2,q5);
    /*
    ...
    plot(s,p);
    */
    float[][] fxy = new float[][]{f,x1,x2};
    System.out.println("np="+fxy[0].length);
    writeFloats("sinsinT",qf);
    writeFloats("sinsinI",q3);
    writeFloats("sinsinFxy",fxy);
  }
  ...
  private static void writeFloats(String fileName, float[][] f) {
    String dataDir = "../../../data/seis/nnint/";
    try {
      ArrayOutputStream aos = new ArrayOutputStream(dataDir+fileName+".dat");
      aos.writeFloats(f);
      aos.close();
    } catch (Exception e) {
