...
def goFaultLikelihood():
  ...
  if not plotOnly:
    ...
    fl = readImage3D("fls")
    fl = pow(fl,0.5)
  plot3(gx,fl,cmin=0.25,cmax=0.8,cmap=jetRamp(1.0),
...
def goPlanar():
  ...
  if not plotOnly:
    ...
    ep = fer.applyForPlanar(30,et3,gx)
...
def plot3(f,g=None,k1=120,k2=298,k3=39,au=300,cmin=-2,cmax=2,
          cmap=None,clab=None,cint=None,cells=None,skinx=None,png=None):
  n3 = len(f)
  n2 = len(f[0])
  n1 = len(f[0][0])
