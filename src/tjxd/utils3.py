...
def setupForSubset(name):
  ...
  if name=="full":
    """ full seismic """
    print "setupForSubset: full"
    seismicDir = _datdir+"3d/seis/"
    pngDir = _pngdir+"3d/"
    n1,n2,n3 = 1501,1000,300 
    d1,d2,d3 = 0.004,25,25 # (s,km/s)
    #d1,d2,d3 = 1.0,25,25 # (s,km/s)
    f1,f2,f3 = 0,657613,4527888 # (s,km/s)
    s1,s2,s3 = Sampling(n1,d1,f1),Sampling(n2,d2,f2),Sampling(n3,d3,f3)
  elif name=="part":
    """ part seismic """
    print "setupForSubset: part"
    seismicDir = _datdir+"3d/seis/part/"
