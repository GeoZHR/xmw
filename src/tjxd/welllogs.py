...
def main(args):
  #fixDensityLogs()
  makeBinaryWellLogs(logDir,dvtDir)

def makeBinaryWellLogs(logDir, dvtDir):
  wldata = WellLog.Data(logDir, dvtDir)
  logs = wldata.getLogsWith("velocity")
  k = 0
  for log in logs:
    if (k<1):
      for vi in log.v:
...
tpDir = "/data/seis/tpd/"
tjDir = "../../../data/seis/tjxd/3d/"
doeWellLogsDir = tpDir+"logs/"
csmWellLogsDir = tpDir+"logs/dat/"
doeWellHeaders = None#doeWellLogsDir+"WellHeaders.txt"
doeDirectionalSurveys = None#doeWellLogsDir+"DirectionalSurveys.txt"
doeWellLogs = ""
csmWellLogs = ""
...
def setGlobals(what):
  ...
  if what=="all":
    ...
    doeWellLogs = doeWellLogsDir+"las/"
