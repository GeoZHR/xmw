...
public class DstCoherence {
   ...
   * @param scale factor for the smoothing
   */
  public DstCoherence(EigenTensors3 et, double scale) { 
    _et3 = et;
    _scale = (float)scale;
    ...
    final float[][] fx, final float[][] g1, final float[][] g2)
  {
    ...
    public void compute(int i2) {
      ...
      float[] fmi = fx[i2m];
      float[] fpi = fx[i2p];
      float[] xmi = new float[n1];
      float[] xpi = new float[n1];
