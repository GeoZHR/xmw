...
def goSaltSurfer():
  ...
  div(ca,max(ca),ca)
  tv = TensorVoting3()
  fc = tv.findCells(ca,u1,u2,u3)
  plot3(gx,ca,cmin=0.1,cmax=0.8,cells=fc,cmap=jetRamp(1.0),png="pss")
  sps = ScreenPoissonSurfer()
  sps.setSmoothings(20,20,20)
  sf = sps.saltIndicator(fc,g1,g2,g3)
  plot3(gx,ca,cmin=0.1,cmax=0.8,cmap=jetRamp(1.0),fbs=sf,png="pss")
