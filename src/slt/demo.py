...
def main(args):
  ...
  sub(dp,min(dp),dp)
  div(dp,max(dp),dp)
  plot3(gx,cp,cmin=0.1,cmax=1.0,cmap=jetRamp(1.0),clab="ep",png="points")
  plot3(gx,ap,cmin=0.1,cmax=1.0,cmap=jetRamp(1.0),clab="ept",png="points")
  '''
  #plot3(gx,dp,cmin=0.1,cmax=1.0,cmap=jetRamp(1.0),png="points")
def goSaltSurfer():
  gx = readImage(gxfile)
  ...
  tv = TensorVoting3()
  fc = tv.findCellsX(0.2,ca,u1,u2,u3)
