...
#pngDir = None
pngDir = "./png/"
seismicDir = "../../../data/seis/hvc/3d/bahamas/"
gxfile = "gxSub"
s1 = Sampling(251,0.004,0.500)
s2 = Sampling(357,0.025,0.000)
s3 = Sampling(161,0.025,0.000)
s1 = Sampling(185,1.0,0.500)
s2 = Sampling(500,1.0,0.000)
s3 = Sampling(500,1.0,0.000)
...
def goFlattenWithSlopesAndCorrelations():
  ...
  if not plotOnly:
    ...
    rgf = RecursiveExponentialFilter(0)
    rgf.apply1(f,fs)
    gc = GlobalCorrelationFinder(-35,35)
    gc.setStrainMax(0.2)
    ks = gc.getTraceIndexes(5,5,20,0.1,wp)
