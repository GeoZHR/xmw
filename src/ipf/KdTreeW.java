 ...
 */
public class KdTreeW<T extends KdTreeW.XYZPoint> {
     ...
     *            of XYZPoints.
     */
    public KdTreeW(List<XYZPoint> list) {
     ...
     */
    private static final <T extends KdTreeW.XYZPoint> 
      KdNode getNode(KdTreeW<T> tree, T value) {
    ...
    private static final <T extends KdTreeW.XYZPoint> 
      void searchNode(T value, KdNode node, int K,
