 ...
 * @version Modified by Xinming on 02/23/2015
 */
public class LocalOrientFilterX {
  ...
  public void setLocalSmoothingFilter(float[][][] scale) {
    _scale = scale;
  }
    ...
    float[][][] ep, float[][][] el)
  {
    ...
    */
    ...
    if (_rgfSmoother1!=null || _rgfSmoother2!=null || _rgfSmoother3!=null) {
      ...
      float[][][][] gs = {g11,g22,g33,g12,g13,g23};
      for (float[][][] g:gs) {
        smooth1(_sigma1,_scale,g);
        smooth2(_sigma2,_scale,g);
        smooth3(_sigma3,_scale,g);
      }
    }
