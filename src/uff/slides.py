...
def main(args):
  ...
  fa = fillfloat(0.9,n1,n2,n3)
  fn = fillfloat(0.0,n1,n2,n3)
  FaultSkin.setValuesOnFaults(0.0,skins,fa)
  FaultSkin.setValuesOnFaults(0.9,skins,fn)
  plot3(fa,cmin=0,cmax=1,cmap=ColorMap.JET,png="awayFaults")
  plot3(fn,cmin=0,cmax=1,cmap=ColorMap.JET,png="nearFaults")
  #plot3(fn,sn,cmin=0,cmax=1,cmap=jetFillExceptMin(1.0),png="nearFaults")
