...
def goFigures():
  ...
  ml = 33
  strainMax = 0.5
  dw = ShapeDynamicWarping(-ml,ml,10)
  dw.setShiftSmoothing(5)
  dw.setErrorExtrapolation(ShapeDynamicWarping.ErrorExtrapolation.AVERAGE)
