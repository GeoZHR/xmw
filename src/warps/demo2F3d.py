...
def goDtw():
  ...
  #plot1s(s1,[f1,f2])
  #plot1s(s1,[f1,f2],us=us,color=Color.BLUE,png="dtw")
  plotc(s1,s2,f,k21=k21,k22=k22,us=us,w1=800,w2=1050,color=Color.BLUE,png="f3dc")

  f1 = f[k21]
  f2 = f[k22]
  us = zerofloat(n1)
  dw = ShapeDynamicWarping(smin,smax,10)
  dw.setStrainMax(1.0)
  dw.findShifts(f1,f2,us)
  g2 = dw.applyShifts(us,f2)
  #plot1s(s1,[f1,f2])
  #plot1s(s1,[f1,f2],us=us,png="dtw")
  plotc(s1,s2,f,k21=k21,k22=k22,us=us,w1=800,w2=1050,png="f3dc")
...
def plot1s(s1,ys,us=None,vmin=None,vmax=None,color=Color.RED,hcolor=Color.CYAN,
...
def plotc(s1,s2,x,k21=540,k22=650,us=None,
         w1=1000,w2=500,cmap=ColorMap.GRAY,cmin=0,cmax=0,color=Color.RED,title=None,png=None):
